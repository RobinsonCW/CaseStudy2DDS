...
ggplot(data=data.numeric, aes(data.numeric$YearsSinceLastPromotion)) + geom_histogram()
...
# original scale
classifications = knn(train[,c(1:10)],test[,c(1:10)], train$Attrition, prob = TRUE, k = 5)
...
train.indices <- createDataPartition(y = data.mod$Attrition,p = 0.70, list = FALSE)
